...
# Inicializar
pygame.init()
pygame.mixer.music.load("star-wars-main-theme-full (2).ogg")
...
while en_juego:
    ...
    while en_inicio:
        ...
        historia = [
            ...
            "            Es un juego de Pacman un poco diferente.",
            "               Los fantasmas te estan atacando ",
            "              desde una base, quieren que pierdas la",
            "                    primera batalla en contra del",
            "                    malvado Imperio Fantasmagolico.",
    ...
    while en_partida:
        ...
        while en_final:
            ...
            historia_perdido = [
                "   Parece que no has conseguido pasar. Tienes que ",
                "    reiniciar el juego. Si quieres volver a intenar",
